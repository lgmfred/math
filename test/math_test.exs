defmodule MathTest do
  ...
  describe "add/2" do
    ...
    test "incompatible types (integer and string)" do
      assert_raise ArgumentError, "5 and \"5\" are invalid inputs", fn ->
        Math.add(5, "5")
      end

      assert_raise ArgumentError, "5 and \"foo\" are invalid inputs", fn ->
        Math.add(5, "foo")
      end
    end

    test "invalid types (range and nil)" do
      assert_raise ArgumentError, "1..10 and nil are invalid inputs", fn ->
        Math.add(1..10, nil)
      end
    end
  end
